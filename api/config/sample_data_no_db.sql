...
-- NOTE: Make sure you've selected your database first
-- Or replace 'restaurant_db' below with your actual database name
...
(1, 'Admin', 'admin@admin.com', 'admin123', '+1234567890', '123 Admin Street, City, State 12345', 'admin'),
...
(1, 2, 'John Doe', 'john@example.com', 648.00, 5.00, 653.00, 'Delivered', '456 Customer Avenue, Town, State 67890', '2024-01-15', '14:30:00');
...
-- Order 2
INSERT INTO orders (id, user_id, customer_name, customer_email, subtotal, delivery_fee, total, status, address, order_date, order_time) VALUES
(2, 3, 'Jane Smith', 'jane@example.com', 927.00, 5.00, 932.00, 'Processing', '789 Oak Road, Village, State 11111', '2024-01-16', '18:45:00');
...
-- Order 3
INSERT INTO orders (id, user_id, customer_name, customer_email, subtotal, delivery_fee, total, status, address, order_date, order_time) VALUES
(3, 4, 'Mike Johnson', 'mike@example.com', 1197.00, 5.00, 1202.00, 'Shipped', '321 Pine Street, City, State 22222', '2024-01-16', '19:15:00');
...
-- Order 4
INSERT INTO orders (id, user_id, customer_name, customer_email, subtotal, delivery_fee, total, status, address, order_date, order_time) VALUES
(4, 5, 'Sarah Williams', 'sarah@example.com', 537.00, 5.00, 542.00, 'Pending', '654 Maple Avenue, Town, State 33333', CURDATE(), CURTIME());
...
-- Order 5
INSERT INTO orders (id, user_id, customer_name, customer_email, subtotal, delivery_fee, total, status, address, order_date, order_time) VALUES
(5, 2, 'John Doe', 'john@example.com', 806.00, 5.00, 811.00, 'Processing', '456 Customer Avenue, Town, State 67890', CURDATE(), CURTIME());
...
ALTER TABLE offers AUTO_INCREMENT = 7;
